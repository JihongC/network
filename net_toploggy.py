...
class NetTop:
    ...
    def built_top(self):
        ...
        for num_core in tqdm(range(self._num_core),desc='Building main Toploggy'):
            ...
            self.graph.add_edges_from(core_edges, layer='core layer', bandwidth=100, IGP_num=num_core + 1,
            ...
            for num_converge in range(self._num_converge):
                ...
                self.graph.add_edges_from(converge_edges, layer='converge layer', bandwidth=10, IGP_num=num_core + 1,
                ...
                self.graph.add_edges_from(
                    ...
                    layer='converge layer', bandwidth=10, IGP_num=num_core + 1,
                    ring_num=num_converge + 1, delay=0.1)
                ...
                for num_access in range(self._num_access):
                    ...
                    self.graph.add_edges_from(access_edges, layer='access layer', bandwidth=1, IGP_num=num_core + 1,
                    ...
                    self.graph.add_edges_from(
                        ...
                        layer='access layer', bandwidth=1, IGP_num=num_core + 1, CONV_num=num_converge + 1,
            ...
            if num_core > 0:
                ...
                self.graph.add_edges_from(metro_cross, layer='metro cross', bandwidth=1000, IGP_num=num_core + 1,
    ...
    def generate_flows(self, flow_num, clear=True):
        if clear:
            self.flows.clear()
        source_nodes = []
        ...
        for num_flow in tqdm(range(flow_num), desc='Generating flows'):
            ...
            while not self._helper_vail_s_d(s, d):
                d = int(np.random.choice(dest_nodes, 1))
            self.flows.append(Flow(num_flow, s, d, 0.1, self.graph))
